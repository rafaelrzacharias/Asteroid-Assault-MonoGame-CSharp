...
public class AsteroidManager
{
    ...
    public AsteroidManager(int asteroidCount, Texture2D texture, 
        Rectangle initialFrame, int asteroidFrames, int screenWidth, int screenHeight)
    {
    ...
    private Vector2 RandomLocation()
    {
        ...
        do
        {
            ...
            {
                if (asteroid.IsBoxColliding(new Rectangle(
    ...
    private Vector2 RandomVelocity()
    {
        Vector2 velocity = new Vector2(
            rand.Next(0, 101) - 50, rand.Next(0, 101) - 50);
        velocity.Normalize();
    ...
    private bool IsOnScreen(Sprite asteroid)
    {
        if (asteroid.Destination.Intersects(
            new Rectangle(-screenPadding, -screenPadding, 
